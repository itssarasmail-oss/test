...
function VideoCard({ imageSrc, title, url, index }) {
  return (
    <div
...
/* ───────── Section Header ───────── */
function SectionHeader({ title, subtitle, step, selection, onNavigate }) {
  return (
...
/* ───────── Breadcrumbs ───────── */
function Breadcrumbs({ step, selection, onNavigate }) {
  return (
